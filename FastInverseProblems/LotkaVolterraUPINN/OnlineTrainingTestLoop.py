...
modelNums = [10,30,50,100]
for resNum in modelNums:
    print(f"Res trained with {resNum} outputs")
    ...
    with timer("Online Training"):
        ...
        Reservoir.load_state_dict(torch.load(f"Reservoir{resNum}.pt",weights_only=True))
        Reservoir.eval()
